...
namespace Hoteleria
{
    public partial class Agregar_platillos : Form
    {
        ...
        public void mostrarPlatillos()
        {
            try
            {
                da = new OdbcDataAdapter("select pl.idPlatillo as 'No Platillo',pl.nombrePlatillo as Platillo, r.nombre as Receta, dpp.cantidadPlatillo as Cantidad,(pl.costoPlatillo*dpp.cantidadPlatillo) as Costo from platillo pl inner join receta r on pl.receta_idReceta = r.idReceta inner join detallepedidoplatillo dpp on dpp.platillo_idPlatillo = pl.idPlatillo inner join pedido p on p.idPedido = dpp.pedido_idPedido where p.idPedido = "+Convert.ToInt32(txt_noPedido.Text)+" ", con.conexion());
                dt = new DataTable();
                da.Fill(dt);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    //INGRESO PEDIDO
                    com = new OdbcCommand("insert into detallepedidoplatillo (cantidadPlatillo, pedido_idPedido, platillo_idPlatillo) values (" + Convert.ToInt32(txt_cantPlatillos.Text) + "," + Convert.ToInt32(txt_noPedido.Text) + ", " + id_platillo + " )", con.conexion());
                    com.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    com = new OdbcCommand("update detallepedidoplatillo set platillo_idPlatillo=" + id_platillos + ", cantidadPlatillo=" + Convert.ToInt32(txt_cantPlatillos.Text) + " where pedido_idPedido=" + Convert.ToInt32(txt_noPedido.Text) + " and platillo_idPlatillo=" + id_platillos2 + " ", con.conexion());
                    com.ExecuteNonQuery();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                com = new OdbcCommand("delete from detallepedidoplatillo where pedido_idPedido=" + Convert.ToInt32(txt_noPedido.Text) + " and platillo_idPlatillo="+id_platillos+" ", con.conexion());
                com.ExecuteNonQuery();
