    ...
    public partial class Agregar_bebidas : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            {  //BEBIDA 
                ...
                else
                {
                    ...
                    //INGRESO BEBIDA
                    com = new OdbcCommand("insert into detallepedidobebida (cantidadBebida, pedido_idPedido, productos_idProducto) values (" + Convert.ToInt32(txt_cantBebida.Text) + "," + Convert.ToInt32(txt_noPedido.Text) + ", " + id_bebida + " )", con.conexion());
                    com.ExecuteNonQuery();
        ...
        private void btn_editar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                com = new OdbcCommand("update detallepedidobebida set productos_idProducto=" + id_bebida + ", cantidadBebida=" + Convert.ToInt32(txt_cantBebida.Text) + " where pedido_idPedido="+Convert.ToInt32(txt_noPedido.Text)+" and productos_idProducto="+id_bebidas2+" ", con.conexion());
                com.ExecuteNonQuery();
        ...
        private void btn_borrar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                com = new OdbcCommand("delete from detallepedidobebida where pedido_idPedido=" + Convert.ToInt32(txt_noPedido.Text) + " and productos_idProducto=" + id_bebidas + " ", con.conexion());
                com.ExecuteNonQuery();
